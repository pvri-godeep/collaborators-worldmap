...
coordTable  <- read.table("var/build/target/coords.csv", 
                          header = TRUE, 
                          sep=";")

svg(filename="var/build/target/worldmap-latest.svg", width=9, height=6)
...
svg(filename="var/build/target/worldmap-web-latest.svg", width=9, height=6)
